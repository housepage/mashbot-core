...
package org.mashbot.server.ext.blogger;

import com.google.gdata.client.Query;
import com.google.gdata.client.blogger.BloggerService;
import org.mashbot.server.ext.google.SimpleCommandLineParser;
...
public class BloggerClient {
   ...
   */
  public static String getBlogId(BloggerService myService)
  ...
  public static Entry createPost(BloggerService myService, String title,
      String content, String authorName, String userName, Boolean isDraft, String blogId)
      throws ServiceException, IOException {
  ...
  public static void run(BloggerService myService, String userName,
    ...
    Entry publicPost = createPost(myService, "Back from vacation",
        ...
        "Post author", userName, false, blogId);
